 ...
 * (samples/drivers/video/mipi_capture_to_enc/src/usb_cdc_transport.c).
 * Not FHD/quadrant-specific - this file already sends one arbitrary-size
 * JPEG buffer per call, so Lab C5 (single 480x270 frame per call) needed
